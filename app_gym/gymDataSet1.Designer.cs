...
namespace app_gym {
    ...
    public partial class gymDataSet1 : global::System.Data.DataSet {
        ...
        public partial class clientesDataTable : global::System.Data.TypedTableBase<clientesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "18.0.0.0")]
            public clientesRow AddclientesRow(string nombre, string apellidos, string correo, byte[] huella, System.DateTime fecha_inscripcion) {
        ...
        public partial class clientesRow : global::System.Data.DataRow {
            ...
            public byte[] huella {
                get {
                    try {
                        return ((byte[])(this[this.tableclientes.huellaColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("El valor de la columna \'huella\' de la tabla \'clientes\' es DBNull.", e);
                    }
                }
                set {
                    this[this.tableclientes.huellaColumn] = value;
                }
            }
            ...
            public System.DateTime fecha_inscripcion {
                get {
                    try {
                        return ((global::System.DateTime)(this[this.tableclientes.fecha_inscripcionColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("El valor de la columna \'fecha_inscripcion\' de la tabla \'clientes\' es DBNull.", e);
                    }
                }
                set {
                    this[this.tableclientes.fecha_inscripcionColumn] = value;
                }
            }
            ...
            public bool IshuellaNull() {
                return this.IsNull(this.tableclientes.huellaColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "18.0.0.0")]
            public void SethuellaNull() {
                this[this.tableclientes.huellaColumn] = global::System.Convert.DBNull;
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "18.0.0.0")]
            public bool Isfecha_inscripcionNull() {
                return this.IsNull(this.tableclientes.fecha_inscripcionColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "18.0.0.0")]
            public void Setfecha_inscripcionNull() {
                this[this.tableclientes.fecha_inscripcionColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace app_gym.gymDataSet1TableAdapters {
    ...
    public partial class clientesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[clientes] WHERE (([id] = @Original_id) AND ([nombre] = @Original_nombre) AND ([apellidos] = @Original_apellidos) AND ([correo] = @Original_correo) AND ((@IsNull_fecha_inscripcion = 1 AND [fecha_inscripcion] IS NULL) OR ([fecha_inscripcion] = @Original_fecha_inscripcion)))";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@IsNull_fecha_inscripcion", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "fecha_inscripcion", global::System.Data.DataRowVersion.Original, true, null, "", "", ""));
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_fecha_inscripcion", global::System.Data.SqlDbType.Date, 0, global::System.Data.ParameterDirection.Input, 0, 0, "fecha_inscripcion", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[clientes] ([nombre], [apellidos], [correo], [huella], [fecha_inscripcion]) VALUES (@nombre, @apellidos, @correo, @huella, @fecha_inscripcion);
SELECT id, nombre, apellidos, correo, huella, fecha_inscripcion FROM clientes WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@fecha_inscripcion", global::System.Data.SqlDbType.Date, 0, global::System.Data.ParameterDirection.Input, 0, 0, "fecha_inscripcion", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[clientes] SET [nombre] = @nombre, [apellidos] = @apellidos, [correo] = @correo, [huella] = @huella, [fecha_inscripcion] = @fecha_inscripcion WHERE (([id] = @Original_id) AND ([nombre] = @Original_nombre) AND ([apellidos] = @Original_apellidos) AND ([correo] = @Original_correo) AND ((@IsNull_fecha_inscripcion = 1 AND [fecha_inscripcion] IS NULL) OR ([fecha_inscripcion] = @Original_fecha_inscripcion)));
SELECT id, nombre, apellidos, correo, huella, fecha_inscripcion FROM clientes WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@fecha_inscripcion", global::System.Data.SqlDbType.Date, 0, global::System.Data.ParameterDirection.Input, 0, 0, "fecha_inscripcion", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@IsNull_fecha_inscripcion", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "fecha_inscripcion", global::System.Data.DataRowVersion.Original, true, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_fecha_inscripcion", global::System.Data.SqlDbType.Date, 0, global::System.Data.ParameterDirection.Input, 0, 0, "fecha_inscripcion", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::app_gym.Properties.Settings.Default.gymConnectionString1;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, nombre, apellidos, correo, huella, fecha_inscripcion FROM dbo.clientes" +
                "";
        ...
        public virtual int Fill(gymDataSet1.clientesDataTable dataTable) {
        ...
        public virtual gymDataSet1.clientesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            gymDataSet1.clientesDataTable dataTable = new gymDataSet1.clientesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "18.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(gymDataSet1.clientesDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_nombre, string Original_apellidos, string Original_correo, global::System.Nullable<global::System.DateTime> Original_fecha_inscripcion) {
            ...
            if ((Original_fecha_inscripcion.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[5].Value = ((System.DateTime)(Original_fecha_inscripcion.Value));
            }
            else {
        ...
        public virtual int Insert(string nombre, string apellidos, string correo, byte[] huella, global::System.Nullable<global::System.DateTime> fecha_inscripcion) {
            if ((nombre == null)) {
            ...
            if ((huella == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[3].Value = ((byte[])(huella));
            }
            if ((fecha_inscripcion.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[4].Value = ((System.DateTime)(fecha_inscripcion.Value));
            }
            else {
        ...
        public virtual int Update(string nombre, string apellidos, string correo, byte[] huella, global::System.Nullable<global::System.DateTime> fecha_inscripcion, int Original_id, string Original_nombre, string Original_apellidos, string Original_correo, global::System.Nullable<global::System.DateTime> Original_fecha_inscripcion, int id) {
            if ((nombre == null)) {
                throw new global::System.ArgumentNullException("nombre");
            }
            else {
            ...
            if ((huella == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[3].Value = ((byte[])(huella));
            }
            if ((fecha_inscripcion.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[4].Value = ((System.DateTime)(fecha_inscripcion.Value));
            }
            else {
            ...
            if ((Original_fecha_inscripcion.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[10].Value = ((System.DateTime)(Original_fecha_inscripcion.Value));
            }
            else {
        ...
        public virtual int Update(string nombre, string apellidos, string correo, byte[] huella, global::System.Nullable<global::System.DateTime> fecha_inscripcion, int Original_id, string Original_nombre, string Original_apellidos, string Original_correo, global::System.Nullable<global::System.DateTime> Original_fecha_inscripcion) {
            return this.Update(nombre, apellidos, correo, huella, fecha_inscripcion, Original_id, Original_nombre, Original_apellidos, Original_correo, Original_fecha_inscripcion, Original_id);
        }
    }
